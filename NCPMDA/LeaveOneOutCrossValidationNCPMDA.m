function [FinalCandiRankList,AUC] = LeaveOneOutCrossValidationNCPMDA(DataPath,mi2diNetwork)
...
for i=1:length(Disease_name) %#ok<USENS>
    ...
    for j=1:length(miRNABin)
        ...
        TempCandi=NCPMDA([miRNABin{j};CandiMiRNA],miRNA_name,MiFunSim,DiPheSim,Tempmi2diNetwork,i);
