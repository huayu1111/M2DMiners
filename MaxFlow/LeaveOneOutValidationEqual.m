function [FinalCandiRankList,AUC] = LeaveOneOutValidationEqual(DataPath,Heter_Network)
%===========================================================================================
...
for i=1:length(Disease_name) %#ok<USENS>
    ...
    PermIndex=randperm(length(CandiMiRNAs));
    RandomNum=PermIndex(1:length(miRNABin));
    CandiMiRNAs=CandiMiRNAs(RandomNum);
