function [FinalCandiRankList,AUC] = LeaveOneOutValidationWithUnknownAssociation50(DataPath,Heter_Network,Num)
%===================================================================================================
% [FinalCandiRankList,AUC] = LeaveOneOutValidationWithKnownAssiciation(DataPath,Heter_Network,Num)
% ==================================================================================================
...
for i=1:length(Disease_name) %#ok<USENS>
    ...
    PermIndex=randperm(length(miRNA_name));
    RandomNum=PermIndex(1:Num);
    CandiMiRNAs=miRNA_name(RandomNum);
    CandiMiRNAs=setdiff(CandiMiRNAs,miRNABin);
