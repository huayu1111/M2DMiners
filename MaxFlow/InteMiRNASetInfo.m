function [mi2diNetwork] =InteMiRNASetInfo(DataPath,mi2diNetwork,Alta,Beta,Gamma)
%===========================================================================================
        ...
        if isempty(miRNAinterSet)
            ...
            for k=1:length(miRNAinterSet)
                ...
                if isempty(microRNA_Row)
                    ...
                    mi2diNetwork(microRNA_Row,j)=mi2diNetwork(microRNA_Row,j)+Gamma*length(miRNAinterSet)/(Alta*length(miRNA_set1)); %#ok<AGROW>
                end
            end
        end
    end
