function [ResultsArray] = ParaOptimalDiseasesWithUnknownAssociation(MiTop,DiTop,AltaTop,BetaTop)
%=============================================================================================
    ...
    for DiPheField=0.1:0.1:DiTop
        for Alta=1:1:(AltaTop)
            for Beta=1:1:(BetaTop)
                ...
                [~,AucValue]=LeaveOneOutValidationDiseasesWithUnknownAssociation(DataPath,Heter_Network);
